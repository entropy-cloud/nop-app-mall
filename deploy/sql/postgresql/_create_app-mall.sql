...
CREATE TABLE litemall_aftersale(
  ...
  return_ship_channel VARCHAR(63)  ,
  return_ship_sn VARCHAR(63)  ,
  return_time TIMESTAMP  ,
  receive_confirm_time TIMESTAMP  ,
...
CREATE TABLE litemall_promotion_usage(
  id INT4 NOT NULL ,
  user_id VARCHAR(50) NOT NULL ,
  promotion_activity_id INT4 NOT NULL ,
  order_id INT4 NOT NULL ,
  meet_amount NUMERIC(10,2)  ,
