...
alter table litemall_user_tag add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table litemall_user_blacklist add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_points_expire_batch add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_points_goods add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_promotion_usage add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_points_exchange_order add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_points_goods drop constraint PK_litemall_points_goods;
alter table litemall_points_goods add constraint PK_litemall_points_goods primary key (NOP_TENANT_ID, ID);
...
alter table litemall_promotion_usage drop constraint PK_litemall_promotion_usage;
alter table litemall_promotion_usage add constraint PK_litemall_promotion_usage primary key (NOP_TENANT_ID, ID);
...
alter table litemall_points_exchange_order drop constraint PK_litemall_points_exchange_order;
alter table litemall_points_exchange_order add constraint PK_litemall_points_exchange_order primary key (NOP_TENANT_ID, ID);
