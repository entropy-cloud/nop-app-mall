...
alter table litemall_admin add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_permission add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table litemall_region add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table litemall_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
...
alter table litemall_user add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;

alter table litemall_user_role add NOP_TENANT_ID VARCHAR2(32) DEFAULT '0' NOT NULL;
