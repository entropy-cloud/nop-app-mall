...
CREATE TABLE litemall_member_level(
  ...
  NAME VARCHAR2(63) NOT NULL ,
  UPGRADE_THRESHOLD NUMBER(10,2)  ,
  DOWNGRADE_THRESHOLD NUMBER(10,2)  ,
  BENEFITS VARCHAR2(1023)  ,
  SORT_ORDER INTEGER  ,
  REMARK VARCHAR2(255)  ,
  ADD_TIME DATE  ,
  UPDATE_TIME DATE  ,
...
CREATE TABLE litemall_points_exchange_order(
  ID INTEGER NOT NULL ,
  USER_ID VARCHAR2(50) NOT NULL ,
  POINTS_GOODS_ID INTEGER NOT NULL ,
  GOODS_ID INTEGER NOT NULL ,
  PRODUCT_ID INTEGER  ,
  GOODS_NAME VARCHAR2(127)  ,
  PIC_URL VARCHAR2(255)  ,
