//__XGEN_FORCE_OVERRIDE__
    ...
    public class LitemallCouponOutputBean {
        ...
        private String _goodsType_label;

    
        public String getGoodsType_label(){
            return _goodsType_label;
        }

        public void setGoodsType_label(String value){
            this._goodsType_label = value;
        }
        ...
        private String _timeType_label;

    
        public String getTimeType_label(){
            return _timeType_label;
        }

        public void setTimeType_label(String value){
            this._timeType_label = value;
        }
