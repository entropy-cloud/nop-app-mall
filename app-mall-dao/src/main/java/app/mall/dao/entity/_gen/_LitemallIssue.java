...
/**
 *  常见问题表: litemall_issue
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallIssue extends DynamicOrmEntity{
    
    /* Id: ID INTEGER */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 问题标题: QUESTION VARCHAR */
    public static final String PROP_NAME_question = "question";
    public static final int PROP_ID_question = 2;
    
    /* 问题答案: ANSWER VARCHAR */
    public static final String PROP_NAME_answer = "answer";
    public static final int PROP_ID_answer = 3;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_question] = PROP_NAME_question;
          PROP_NAME_TO_ID.put(PROP_NAME_question, PROP_ID_question);
      
          PROP_ID_TO_NAME[PROP_ID_answer] = PROP_NAME_answer;
          PROP_NAME_TO_ID.put(PROP_NAME_answer, PROP_ID_answer);
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallIssue";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_question:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_question));
               }
               setQuestion(typedValue);
               break;
            }
            ...
            case PROP_ID_answer:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_answer));
               }
               setAnswer(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_question:{
               onInitProp(propId);
               this._question = (java.lang.String)value;
            ...
            case PROP_ID_answer:{
               onInitProp(propId);
               this._answer = (java.lang.String)value;
     ...
     * 问题标题: QUESTION
     */
    public final void setQuestion(java.lang.String value){
        if(onPropSet(PROP_ID_question,value)){
            this._question = value;
            internalClearRefs(PROP_ID_question);
     ...
     * 问题答案: ANSWER
     */
    public final void setAnswer(java.lang.String value){
        if(onPropSet(PROP_ID_answer,value)){
            this._answer = value;
            internalClearRefs(PROP_ID_answer);
