...
/**
 *  用户角色: litemall_user_role
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallUserRole extends DynamicOrmEntity{
    ...
    protected static final List<String> PK_PROP_NAMES = Arrays.asList(PROP_NAME_userId,PROP_NAME_roleId);
    protected static final int[] PK_PROP_IDS = new int[]{PROP_ID_userId,PROP_ID_roleId};
    ...
    public _LitemallUserRole(){
        // for debug
    }

    protected LitemallUserRole newInstance(){
        LitemallUserRole entity = new LitemallUserRole();
    ...
    @Override
    public LitemallUserRole cloneInstance() {
        LitemallUserRole entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallUserRole";
    }
    ...
    public boolean orm_isPrimary(int propId) {
            ...
            return propId == PROP_ID_userId || propId == PROP_ID_roleId;
