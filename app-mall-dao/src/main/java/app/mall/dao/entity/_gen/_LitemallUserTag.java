...
/**
 *  用户标签表: litemall_user_tag
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallUserTag extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_tag = 3;
    ...
    public _LitemallUserTag(){
        // for debug
    }

    protected LitemallUserTag newInstance(){
        LitemallUserTag entity = new LitemallUserTag();
    ...
    @Override
    public LitemallUserTag cloneInstance() {
        LitemallUserTag entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallUserTag";
    }
