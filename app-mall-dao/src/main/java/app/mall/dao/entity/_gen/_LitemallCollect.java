...
/**
 *  收藏表: litemall_collect
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement"})
public class _LitemallCollect extends DynamicOrmEntity{
    ...
    /* 如果type=0，则是商品ID；如果type=1，则是专题ID: VALUE_ID INTEGER */
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallCollect";
    }
