...
/**
 *  积分账户表: litemall_points_account
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallPointsAccount extends DynamicOrmEntity{
    ...
    /* 当前可用积分: BALANCE INTEGER */
    public static final String PROP_NAME_balance = "balance";
    public static final int PROP_ID_balance = 3;
    
    /* 累计获得: TOTAL_EARNED INTEGER */
    public static final String PROP_NAME_totalEarned = "totalEarned";
    public static final int PROP_ID_totalEarned = 4;
    
    /* 累计消耗: TOTAL_SPENT INTEGER */
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_totalEarned] = PROP_NAME_totalEarned;
          PROP_NAME_TO_ID.put(PROP_NAME_totalEarned, PROP_ID_totalEarned);
    ...
    /* 当前可用积分: BALANCE */
    private java.lang.Integer _balance;
    
    /* 累计获得: TOTAL_EARNED */
    private java.lang.Integer _totalEarned;
    
    /* 累计消耗: TOTAL_SPENT */
    private java.lang.Integer _totalSpent;
    ...
    public _LitemallPointsAccount(){
        // for debug
    }

    protected LitemallPointsAccount newInstance(){
        LitemallPointsAccount entity = new LitemallPointsAccount();
    ...
    @Override
    public LitemallPointsAccount cloneInstance() {
        LitemallPointsAccount entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallPointsAccount";
    }
    ...
    public Object orm_propValue(int propId) {
        switch(propId){
            ...
            case PROP_ID_totalEarned:
               return getTotalEarned();
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_totalEarned:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toInteger(value,
                       err-> newTypeConversionError(PROP_NAME_totalEarned));
               }
               setTotalEarned(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_balance:{
               onInitProp(propId);
               this._balance = (java.lang.Integer)value;
            ...
            case PROP_ID_totalEarned:{
               onInitProp(propId);
               this._totalEarned = (java.lang.Integer)value;
            ...
            case PROP_ID_totalSpent:{
               onInitProp(propId);
               this._totalSpent = (java.lang.Integer)value;
     ...
     * 当前可用积分: BALANCE
     */
    public final void setBalance(java.lang.Integer value){
     ...
     * 累计获得: TOTAL_EARNED
     */
    public final java.lang.Integer getTotalEarned(){
         onPropGet(PROP_ID_totalEarned);
         return _totalEarned;
    }
     ...
     * 累计获得: TOTAL_EARNED
     */
    public final void setTotalEarned(java.lang.Integer value){
        if(onPropSet(PROP_ID_totalEarned,value)){
            this._totalEarned = value;
            internalClearRefs(PROP_ID_totalEarned);
     ...
     * 累计消耗: TOTAL_SPENT
     */
    public final java.lang.Integer getTotalSpent(){
     ...
     * 累计消耗: TOTAL_SPENT
     */
    public final void setTotalSpent(java.lang.Integer value){
