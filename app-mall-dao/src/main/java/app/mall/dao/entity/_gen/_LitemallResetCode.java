...
/**
 *  密码重置验证码: litemall_reset_code
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallResetCode extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_mobile = 2;
    ...
    public _LitemallResetCode(){
        // for debug
    }

    protected LitemallResetCode newInstance(){
        LitemallResetCode entity = new LitemallResetCode();
    ...
    @Override
    public LitemallResetCode cloneInstance() {
        LitemallResetCode entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallResetCode";
    }
