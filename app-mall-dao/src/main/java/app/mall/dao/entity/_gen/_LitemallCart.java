...
/**
 *  购物车商品表: litemall_cart
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallCart extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_goodsSn = 4;
    
    /* 商品名称: GOODS_NAME VARCHAR */
    public static final String PROP_NAME_goodsName = "goodsName";
    public static final int PROP_ID_goodsName = 5;
    ...
    /* 商品货品的价格: PRICE DECIMAL */
    public static final String PROP_NAME_price = "price";
    public static final int PROP_ID_price = 7;
    
    /* 商品货品的数量: NUMBER SMALLINT */
    ...
    /* 购物车中商品是否选择状态: CHECKED BOOLEAN */
    public static final String PROP_NAME_checked = "checked";
    public static final int PROP_ID_checked = 10;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_checked] = PROP_NAME_checked;
          PROP_NAME_TO_ID.put(PROP_NAME_checked, PROP_ID_checked);
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallCart";
    }
            ...
            case PROP_ID_checked:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toBoolean(value,
                       err-> newTypeConversionError(PROP_NAME_checked));
               }
               setChecked(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_productId:{
               onInitProp(propId);
               this._productId = (java.lang.Integer)value;
            ...
            case PROP_ID_checked:{
               onInitProp(propId);
               this._checked = (java.lang.Boolean)value;
     ...
     * 购物车中商品是否选择状态: CHECKED
     */
    public final void setChecked(java.lang.Boolean value){
        if(onPropSet(PROP_ID_checked,value)){
            this._checked = value;
            internalClearRefs(PROP_ID_checked);
