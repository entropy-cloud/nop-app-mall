...
public class _LitemallCategory extends DynamicOrmEntity{
   ...
   private io.nop.orm.support.OrmFileComponent _iconUrlComponent;

   private static Map<String,Integer> COMPONENT_PROP_ID_MAP_iconUrlComponent = new HashMap<>();
   static{
      
         COMPONENT_PROP_ID_MAP_iconUrlComponent.put(io.nop.orm.support.OrmFileComponent.PROP_NAME_filePath,PROP_ID_iconUrl);
      
   }

   public io.nop.orm.support.OrmFileComponent getIconUrlComponent(){
      if(_iconUrlComponent == null){
          _iconUrlComponent = new io.nop.orm.support.OrmFileComponent();
