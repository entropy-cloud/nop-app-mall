...
/**
 *  权限表: litemall_permission
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallPermission extends DynamicOrmEntity{
    
    /* Id: ID INTEGER */
    public static final String PROP_NAME_id = "id";
    public static final int PROP_ID_id = 1;
    
    /* 角色ID: ROLE_ID INTEGER */
    public static final String PROP_NAME_roleId = "roleId";
    public static final int PROP_ID_roleId = 2;
    
    /* 权限: PERMISSION VARCHAR */
    public static final String PROP_NAME_permission = "permission";
    public static final int PROP_ID_permission = 3;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_permission] = PROP_NAME_permission;
          PROP_NAME_TO_ID.put(PROP_NAME_permission, PROP_ID_permission);
    ...
    /* 角色ID: ROLE_ID */
    private java.lang.Integer _roleId;
    ...
    public _LitemallPermission(){
        // for debug
    }

    protected LitemallPermission newInstance(){
        LitemallPermission entity = new LitemallPermission();
    ...
    @Override
    public LitemallPermission cloneInstance() {
        LitemallPermission entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallPermission";
    }
            ...
            case PROP_ID_permission:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_permission));
               }
               setPermission(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_roleId:{
               onInitProp(propId);
               this._roleId = (java.lang.Integer)value;
            ...
            case PROP_ID_permission:{
               onInitProp(propId);
               this._permission = (java.lang.String)value;
     ...
     * 角色ID: ROLE_ID
     */
    public final void setRoleId(java.lang.Integer value){
     ...
     * 权限: PERMISSION
     */
    public final void setPermission(java.lang.String value){
        if(onPropSet(PROP_ID_permission,value)){
            this._permission = value;
            internalClearRefs(PROP_ID_permission);
