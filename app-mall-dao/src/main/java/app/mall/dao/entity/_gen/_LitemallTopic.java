...
public class _LitemallTopic extends DynamicOrmEntity{
   ...
   private io.nop.orm.support.JsonOrmComponent _goodsComponent;

   private static Map<String,Integer> COMPONENT_PROP_ID_MAP_goodsComponent = new HashMap<>();
   static{
      
         COMPONENT_PROP_ID_MAP_goodsComponent.put(io.nop.orm.support.JsonOrmComponent.PROP_NAME__jsonText,PROP_ID_goods);
      
   }

   public io.nop.orm.support.JsonOrmComponent getGoodsComponent(){
      if(_goodsComponent == null){
          _goodsComponent = new io.nop.orm.support.JsonOrmComponent();
