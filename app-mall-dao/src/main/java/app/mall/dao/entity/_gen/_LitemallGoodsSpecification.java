...
public class _LitemallGoodsSpecification extends DynamicOrmEntity{
    ...
    /* 商品规格名称: SPECIFICATION VARCHAR */
    public static final String PROP_NAME_specification = "specification";
    public static final int PROP_ID_specification = 3;
    
    /* 商品规格值: VALUE VARCHAR */
    public static final String PROP_NAME_value = "value";
    public static final int PROP_ID_value = 4;
    
    /* 商品规格图片: PIC_URL VARCHAR */
    public static final String PROP_NAME_picUrl = "picUrl";
    public static final int PROP_ID_picUrl = 5;
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_specification] = PROP_NAME_specification;
          PROP_NAME_TO_ID.put(PROP_NAME_specification, PROP_ID_specification);
    ...
    private java.lang.String _specification;
    ...
    public _LitemallGoodsSpecification(){
        // for debug
    }
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallGoodsSpecification";
    }
            ...
            case PROP_ID_specification:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_specification));
               }
               setSpecification(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_specification:{
               onInitProp(propId);
               this._specification = (java.lang.String)value;
