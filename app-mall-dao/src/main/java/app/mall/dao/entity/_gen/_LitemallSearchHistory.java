...
/**
 *  搜索历史表: litemall_search_history
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallSearchHistory extends DynamicOrmEntity{
    ...
    static{
          ...
          PROP_ID_TO_NAME[PROP_ID_from] = PROP_NAME_from;
          PROP_NAME_TO_ID.put(PROP_NAME_from, PROP_ID_from);
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallSearchHistory";
    }
    ...
    public void orm_propValue(int propId, Object value){
        switch(propId){
            ...
            case PROP_ID_from:{
               ...
               if(value != null){
                   typedValue = ConvertHelper.toString(value,
                       err-> newTypeConversionError(PROP_NAME_from));
               }
               setFrom(typedValue);
               break;
            }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_from:{
               onInitProp(propId);
               this._from = (java.lang.String)value;
    ...
    public void setFrom(java.lang.String value){
        if(onPropSet(PROP_ID_from,value)){
            this._from = value;
            internalClearRefs(PROP_ID_from);
