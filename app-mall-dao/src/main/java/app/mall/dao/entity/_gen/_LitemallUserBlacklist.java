...
/**
 *  用户黑名单表: litemall_user_blacklist
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallUserBlacklist extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_reason = 3;
    
    /* 操作人ID: OPERATOR_ID VARCHAR */
    ...
    public _LitemallUserBlacklist(){
        // for debug
    }

    protected LitemallUserBlacklist newInstance(){
        LitemallUserBlacklist entity = new LitemallUserBlacklist();
    ...
    @Override
    public LitemallUserBlacklist cloneInstance() {
        LitemallUserBlacklist entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallUserBlacklist";
    }
