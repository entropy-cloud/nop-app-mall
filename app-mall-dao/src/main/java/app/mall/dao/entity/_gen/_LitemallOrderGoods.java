...
/**
 *  订单商品表: litemall_order_goods
 */
@SuppressWarnings({"PMD.UselessOverridingMethod","PMD.UnusedLocalVariable","java:S3008","java:S1602","java:S1128","java:S1161",
        "PMD.UnnecessaryFullyQualifiedName","PMD.EmptyControlStatement","java:S116","java:S115","java:S101","java:S3776"})
public class _LitemallOrderGoods extends DynamicOrmEntity{
    ...
    public static final int PROP_ID_goodsName = 4;
    ...
    /* 订单商品评论，如果是-1，则超期不能评价；如果是0，则可以评价；如果其他值，则是comment表里面的评论ID。: COMMENT INTEGER */
    public static final String PROP_NAME_comment = "comment";
    public static final int PROP_ID_comment = 11;
    ...
    private java.lang.Integer _comment;
    ...
    protected LitemallOrderGoods newInstance(){
        LitemallOrderGoods entity = new LitemallOrderGoods();
    ...
    @Override
    public LitemallOrderGoods cloneInstance() {
        LitemallOrderGoods entity = newInstance();
    ...
    public String orm_entityName() {
      ...
      return "app.mall.dao.entity.LitemallOrderGoods";
    }
    ...
    public void orm_internalSet(int propId, Object value) {
        switch(propId){
            ...
            case PROP_ID_comment:{
               onInitProp(propId);
               this._comment = (java.lang.Integer)value;
